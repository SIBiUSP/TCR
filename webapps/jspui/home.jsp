...
<div class="col-md-4">
    ...
    <div class="panel text-justify">
        ...
        <div class="row tooltip-demo">
            ...
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/12"><img class="img-responsive" src="image/logosusp/ee.jpg" title="Escola de Enfermagem - EE"></a></div>
            ...
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/1211"><img class="img-responsive" src="image/logosusp/eesc.jpg" title="Escola de Engenharia de São Carlos - EESC"></a></div>
            ...
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/18"><img class="img-responsive" src="image/logosusp/fcf.jpg" title="Faculdade de Ciências Farmacêuticas - FCF"></a></div>
            ...
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/13"><img class="img-responsive" src="image/logosusp/fm.jpg" title="Faculdade de Medicina - FM"></a></div>
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/14"><img class="img-responsive" src="image/logosusp/fmrp.jpg" title="Faculdade de Medicina de Ribeirão Preto - FMRP"></a></div> 
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/15"><img class="img-responsive" src="image/logosusp/fmvz.jpg" title="Faculdade de Medicina Veterinária e Zootecnia - FMVZ"></a></div>
            ...
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/17"><img class="img-responsive" src="image/logosusp/fo.jpg" title="Faculdade de Odontologia - FO"></a></div>
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/16"><img class="img-responsive" src="image/logosusp/forp.jpg" title="Faculdade de Odontologia de Ribeirão Preto - FORP"></a></div>
            ...
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/19"><img class="img-responsive" src="image/logosusp/fzea.jpg" title="Faculdade de Zootecnia e Engenharia de Alimentos - FZEA"></a></div>
            <div class="col-md-3" style="margin-bottom: 5px;"><a href="handle/TCR/11"><img class="img-responsive" src="image/logosusp/hrac.jpg" title="Hospital de Reabilitação de Anomalias Craniofaciais - HRAC"></a></div>
